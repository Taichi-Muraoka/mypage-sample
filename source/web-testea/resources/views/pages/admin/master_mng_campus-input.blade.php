...
<x-bs.card :form=true>
    ...
    <x-bs.form-title>校舎コード</x-bs.form-title>
    <p class="edit-disp-indent">{{$editData['campus_cd']}}</p>
    {{-- 余白 --}}
    <div class="mb-3"></div>
    ...
    <x-input.select id="is_hidden" caption="非表示フラグ" :select2=true :mastrData=$hiddenFlagList :editData=$editData
        :select2Search=false :blank=false />

    {{-- hidden --}}
    <x-input.hidden id="_campus_cd" :editData=$editData />
