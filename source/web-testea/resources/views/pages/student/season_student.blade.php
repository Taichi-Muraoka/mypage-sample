...
<x-bs.card-list>
    ...
    <x-bs.table :button=true :smartPhone=true>
        ...
        <tr>
            ...
            <x-bs.td-sp caption="受付終了日">2023/07/10</x-bs.td-sp>
        ...
        <tr>
            ...
            <x-bs.td-sp caption="受付終了日">2023/03/10</x-bs.td-sp>
        ...
        <tr>
            ...
            <x-bs.td-sp caption="受付終了日">2022/12/10</x-bs.td-sp>
            <x-bs.td-sp caption="ステータス">登録済</x-bs.td-sp>
