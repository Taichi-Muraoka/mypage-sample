...
class Schedule extends Model
{
    ...
    protected static function getFieldRules()
    {
        static $_fieldRules = [
            ...
            'create_kind' => ['integer', 'in:0,1,2'],
            'lesson_kind' => ['integer', 'in:1,2,3,4,5,6,7'],
            'how_to_kind' => ['integer', 'in:0,1,2,3,4'],
            'substitute_kind' => ['integer', 'in:0,1,2'],
            'absent_tutor_id' => ['integer'],
            'absent_status' => ['integer', 'in:1,2,3,4,5,6'],
            'tentative_status' => ['integer', 'in:0,1'],
