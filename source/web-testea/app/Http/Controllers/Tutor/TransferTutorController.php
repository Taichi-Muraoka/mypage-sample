...
class TransferTutorController extends Controller
{
    ...
    private function rulesForInputRelated(?Request $request)
    {
        ...
        $validationPreferred1_input = $this->fncTranGetValidateInput1($request, $schedules, true);
        ...
        $validationPreferred2_input = $this->fncTranGetValidateInput2($request, $schedules, true);
        ...
        $validationPreferred3_input = $this->fncTranGetValidateInput3($request, $schedules, true);
