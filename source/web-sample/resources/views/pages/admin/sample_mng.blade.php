...
<x-bs.card-list>
    ...
    {{-- カードヘッダ右 --}}
    <x-slot name="tools">
        <x-button.new href="{{ route('sample_mng-new') }}" caption="新規登録" :small=true />
    </x-slot>
    ...
    <x-bs.table :button=true>
        ...
        <tr v-for="item in paginator.data" v-cloak>
            ...
            <td>
                ...
                <x-button.list-edit vueHref="'{{ route('sample_mng-edit', '') }}/' + item.sample_id" />
            </td>
        </tr>
...
{{-- モーダル --}}
@include('pages.admin.modal.sample_mng-modal')
