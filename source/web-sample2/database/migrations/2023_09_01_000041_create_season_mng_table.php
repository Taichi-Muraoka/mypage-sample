...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('season_mng', function (Blueprint $table) {
            ...
            $table->date('t_start_date')->nullable()->comment('講師受付開始日');
            $table->date('t_end_date')->nullable()->comment('講師受付終了日');
            $table->date('s_start_date')->nullable()->comment('生徒受付開始日');
            $table->date('s_end_date')->nullable()->comment('生徒受付終了日');
