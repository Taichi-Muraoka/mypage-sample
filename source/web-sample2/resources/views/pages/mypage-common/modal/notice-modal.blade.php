...
{{-- 給与情報へのリンク --}}
<x-button.edit vShow="item.type == {{ App\Consts\AppConst::CODE_MASTER_14_9 }}"
    vueHref="'{{ route('salary') }}'" icon="" caption="給与情報 " />
{{-- 追加請求へのリンク --}}
<x-button.edit vShow="item.type == {{ App\Consts\AppConst::CODE_MASTER_14_10 }}"
    vueHref="'{{ route('surcharge') }}'" icon="" caption="追加請求 " />
@endcan
